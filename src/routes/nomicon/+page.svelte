		...
		<div class="flex flex-col lg:col-span-1 background-gradient h-full overflow-hidden p-3">
			<div class="flex items-center gap-1 bg-background-900 shadow-sm shadow-black">
				...
				<div class="flex flex-col justify-start gap-2 mt-1 h-full ml-1">
					<a href="https://evewho.com/character/{mainCharacter.eve_id}" target="_blank" rel="noopener noreferrer" class="border-2 border-background-200 hover:border-primary-50">
			...
			<div class="flex flex-col bg-background-900 text-left shadow-sm shadow-black">
				...
				<div class="px-2">
					<a href="https://esi.goonfleet.com/" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-primary-50 transition-none">
					...
					<a href="https://wiki.goonswarm.org/w/Main_Page" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-primary-50 transition-none">
						Goonswarm Wiki
						<i class="text-xs fas fa-external-link-alt transition-none"></i>
					</a>
					<a href="https://fleets.gnf.lt/dashboard" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-primary-50 transition-none">
						Dankfleet Dashboard
						<i class="text-xs fas fa-external-link-alt transition-none"></i>
					</a>
					<a href="https://affordablecare.goonfleet.com/home" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-primary-50 transition-none">
						Affordable Care - Goonswarm SRP
						<i class="text-xs fas fa-external-link-alt transition-none"></i>
					</a>
					<a href="https://skills.apps.gnf.lt/" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-primary-50 transition-none">
		...
		<div class="lg:col-span-2 background-gradient h-full overflow-hidden">
			<Tabs.Root value="dashboard" class="flex flex-col w-full max-lg:h-fit lg:h-full" onValueChange={onTabChange}>
				<Tabs.List class="flex gap-3 justify-start bg-transparent h-fit w-full border-b-2 rounded-none px-3 py-2">
					<Tabs.Trigger value="dashboard" class="text-xl bg-background-800 text-background-50 data-[state=active]:bg-primary-600 data-[state=active]:text-background-50">
						Dashboard
					</Tabs.Trigger>
					...
					{#if hasRole('director')}
						<Tabs.Trigger value="directors" class="text-xl bg-background-800 text-background-50 data-[state=active]:bg-primary-600 data-[state=active]:text-background-50">
							Director Dashboard
						</Tabs.Trigger>
					{/if}
				</Tabs.List>
